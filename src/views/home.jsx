...
function HomeView() {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className="w-full fixed left-0 top-0 min-h-[260px] h-[35%] max-h-[500px] bg-linear01"></div>
      <Header />
      <div className="w-full fixed left-0 bottom-0 rotate-180 min-h-[260px] h-[35%] max-h-[500px] bg-linear01"></div>
